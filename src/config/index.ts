...
export default {
  ...
  // App display name
  APP_DISPLAY_NAME: parseEnvString('APP_DISPLAY_NAME') || 'Fpoly Chatible',

  // Page persona profile picture
  PERSONA_PROFILE_PICTURE:
    parseEnvString('PERSONA_PROFILE_PICTURE') || 'https://khuong97hd.github.io/img/logo_fpoly_chatbot.png',
